...
export const CONSTANTS = {
  ...
  KNOWLEDGE_MW_API_BASE: env.KNOWLEDGE_MW_API_BASE || '',
  KONG_API_BASE: env.KONG_API_BASE || 'http://kong:8000',
  ...
  OPEN_SABER_USER_REGISTRY_BASE: env.OPEN_SABER_USER_REGISTRY_BASE || '',
  ...
  PROFANITY_SERVICE_API_BASE: env.PROFANITY_SERVICE_API_BASE || '',
